...
async function getLikes(userId) {
    ...
    .then(data => {
        ...
        console.log(previous_amount, current_amount)
...
typedSomething = setInterval(function () {
    if (document.querySelector('[data-testid="typeaheadResult"]') != null) {
        searchButton = document.querySelector('[data-testid="typeaheadResult"]')
